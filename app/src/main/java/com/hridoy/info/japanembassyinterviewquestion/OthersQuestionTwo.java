...
public class OthersQuestionTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Others Question Part Two");
        setContentView(R.layout.activity_others_question_two);
        ...
        mBasicTwoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent BasicIntent = new Intent(OthersQuestionTwo.this,OthersQuestionThree.class);
        ...
        mPreTwoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent PreIntent = new Intent(OthersQuestionTwo.this,OthersQuestionOne.class);
        ...
        mQ1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ1Text.setText(" にほんのしゅしょうのなまえはなんですか.");
        ...
        mAns1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns1Text.setText(" Abe Shinjoさまです");
        ...
        mQ1EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ1Text.setText("　What is the name of the Japanese Prime Minister?");
            }
        });
        ...
        mQ2SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ2Text.setText(" バングラデッシュのだいとうりょうのなまえはなんですか.");
        ...
        mAns2SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns2Text.setText(" Ad.Abdul Hamid MPさまです.");
        ...
        mQ2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ2Text.setText(" What is the name of the Bangladesh president?");
            }
        });
        ...
        mAns2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns2Text.setText(" Ad.Abdul Hamid MP.");
            }
        });
        ...
        mQ3SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ3Text.setText("にほんのだいとうりょうのなまえはなんですか");
        ...
        mQ3EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ3Text.setText(" What is the name of the Japanese president ");
            }
        });
        ...
        mQ4SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ4Text.setText(" バングラデシュの首都 の 名前はなんですか");
        ...
        mQ4EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ4Text.setText(" What is the name of the capital of Bangladesh ");
            }
        });
        ...
        mQ5SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ5Text.setText(" にほんのしょうとのなまえはなんですか");
        ...
        mQ5EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ5Text.setText(" What is the name of the capital of Japan ");
            }
        });
        ...
        mQ6EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ6Text.setText(" What city is Dhaka");
            }
        });
        ...
        mAns6EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns6Text.setText(" It is a busy town");
            }
        });
        ...
        mQ7SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ7Text.setText(" Tokyoはどんなまちですか");
        ...
        mQ7EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ7Text.setText(" What city is Dhaka");
            }
        });
        ...
        mAns7EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns7Text.setText(" It is a busy town.");
            }
        });
        ...
        mAns8SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns8Text.setText(" にほんじんはしんせつでにほんのせいかつはあんぜんですからにほんがすきです.");
        ...
        mQ8EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ8Text.setText(" Why do you like Japan?");
            }
        });
        ...
        mAns8EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns8Text.setText(" I like Japan because Japanese people are kind and Japanese life is safe.");
            }
        });
        ...
        mQ9SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ9Text.setText("  日本にどんなたべものがありましますか .");
        ...
        mAns9SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns9Text.setText(" ライスやテンフラや圆拯ゃにくなどがあります");
        ...
        mQ9EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ9Text.setText(" What kind of food do you have in Japan?");
            }
        });
        ...
        mAns9EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns9Text.setText(" There are rice, tempura and meat etc.");
            }
        });
        ...
        mQ10EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ10Text.setText(" What is Japanese money?");
            }
        });
