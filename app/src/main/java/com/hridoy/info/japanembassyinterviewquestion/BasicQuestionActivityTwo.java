...
public class BasicQuestionActivityTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBasicTwoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent BasicIntent = new Intent(BasicQuestionActivityTwo.this,BasicQuestionActivityThree.class);
