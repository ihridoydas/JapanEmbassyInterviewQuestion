...
public class EduQuestionActivityFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Education Question Part Four");
        setContentView(R.layout.activity_edu_question_four);
        ...
        mBasicTwoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent BasicIntent = new Intent(EduQuestionActivityFour.this,EduQuestionActivityFour.class);
        ...
        mPreTwoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent PreIntent = new Intent(EduQuestionActivityFour.this,EduQuestionActivityTwo.class);
        ...
        mQ1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ1Text.setText(" あなたはにほんのがっこわってからなにをしたいですか。");
        ...
        mAns1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns1Text.setText(" だいがくにはいりたいです");
        ...
        mQ1EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ1Text.setText("　What do you want to do after you go to school in Japan?");
            }
        });
        ...
        mAns1EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns1Text.setText(" I want to go to the university");
            }
        });
        ...
        mQ2SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ2Text.setText(" あなたはだいがくわってからなにをしたいですか.");
        ...
        mQ2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ2Text.setText(" What do you want to do after University?");
            }
        });
        ...
        mAns2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns2Text.setText(" I will return my country.");
            }
        });
        ...
        mQ3SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ3Text.setText("くにヘかえってからなにをしたいですか.");
        ...
        mAns3SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns3Text.setText(" しんぶんのかいしゃではたらきます");
        ...
        mQ3EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ3Text.setText(" What do you want to do when you return to the country?");
            }
        });
        ...
        mAns3EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns3Text.setText(" I will work in a newspaper company");
            }
        });
        ...
        mQ4EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ4Text.setText(" Can you make a verbal noun, verb?");
            }
        });
        ...
        mQ5EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ5Text.setText(" Can you name the day of the week.?");
            }
        });
        ...
        mQ6EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ6Text.setText(" Can you name a month?");
            }
        });
        ...
        mQ7EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ7Text.setText(" Do you can Japanese dates?");
            }
        });
