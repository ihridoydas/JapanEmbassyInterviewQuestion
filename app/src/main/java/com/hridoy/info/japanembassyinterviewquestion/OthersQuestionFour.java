...
public class OthersQuestionFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Others Question Part Four");
        setContentView(R.layout.activity_others_question_four);
        ...
        mPreTwoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent PreIntent = new Intent(OthersQuestionFour.this,OthersQuestionThree.class);
        ...
        mQ1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ1Text.setText(" なんとおやすみなさいといいますか。");
        ...
        mAns1SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns1Text.setText(" ねるまえに Good Night と いいます");
        ...
        mQ1EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ1Text.setText(" How are you saying good night?");
            }
        });
        ...
        mAns1EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns1Text.setText(" Before going to bed I say Good Night.");
            }
        });
        ...
        mQ2SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ2Text.setText(" ごはんをたべるまえになんといいますか。");
        ...
        mQ2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ2Text.setText(" What should I say before eating rice?");
            }
        });
        ...
        mAns2EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns2Text.setText(" I will tell Itadakimasu.");
            }
        });
        ...
        mQ3SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mQ3Text.setText(" ごはんをたべるあとでなんといいますか、");
        ...
        mAns3SayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAns3Text.setText(" ごちそうさまでしたといいますか。");
        ...
        mQ3EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ3Text.setText(" What do you say after eating rice,");
            }
        });
        ...
        mAns3EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAns3Text.setText(" I will tell Gochisosamadeshita.");
            }
        });
        ...
        mQ4EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ4Text.setText(" You have Girlfriend?");
            }
        });
        ...
        mQ5EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ5Text.setText(" What is the color of the Shirt?");
            }
        });
        ...
        mQ6EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ6Text.setText(" What is the color of your pants?");
            }
        });
        ...
        mQ7EnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQ7Text.setText(" What is the color of the tie?");
            }
        });
